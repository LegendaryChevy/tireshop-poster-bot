...
class TeamBuildingPromo:

    class_id = 'TeamBuildingPromo'
    location = None
    drive_service = None
    ...
    def generate_content(self):
        ...
        if not text_content:
            return "Error generating team building promotion message."

        # Select between 1 and 5 random images
        num_images = random.randint(1, 5)
        image_folder_id = self.location["drive_folders"]["staff_parties"]
